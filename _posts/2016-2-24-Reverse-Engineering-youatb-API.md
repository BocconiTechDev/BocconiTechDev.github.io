...
```
###### Comment
Nice, they are using Basic_access_authentication. So, to login one needs to pass `username:password` encoded using the RFC2045-MIME variant of Base64. No need to be scared of `MTExMjIyOnN0cm9uZ3Bhc3M=`, it's just `111222:strongpass`.

#### Authorization, step 2
The second step of initialization is very important, if you are authorized. It lets you get the `id` which will be needed for timetable downloading.
###### Request
```http
	GET /universityapp_prod/api/v6/app/init?os=android HTTP/1.1
...
###### Response
Gives the same massive amount of javascript, what's important is the diff with the unauthorized request. The diff is small
```diff
5,6c5,25
< 	   "auth_session":null,
< 	   "auth_state":0,
...
> 	      "id":null,
> 	      "lastname":"Doe",
> 	      "photo_url":"http:\/\/ks3-mobile.unibocconi.it\/Esse3Photo\/userphoto?userId=[someid]",
> 	      "type":1,
> 	      "user_id":111222
> 	   },
> 	   "auth_state":1,
...
###### Request
```http
	GET /universityapp_prod/api/v6/students/257126/agenda?rl=en&start=20160224 HTTP/1.1
	auth_secret: b0cc0n1s3cr3t
	Authorization: BASIC [REDACTED]
	User-Agent: Dalvik/2.1.0 (Linux; U; Android 6.0; Custom Phone - 6.0.0 - API 23 - 768x1280 Build/MRA58K)
	Host: ks3-mobile.unibocconi.it
...
```http
	...
	[{"date":"\/Date(1456268400000+0100)\/","events":[{"date_end":"\/Date(1456305300000+0100)\/","date_start":"\/Date(1456299900000+0100)\/","description":"20193 CLEFIN-FINANCE - Annunziata F.","id":10424,"supertitle":"Room N35","title":"Financial institutions and markets law","type":1},{"date_end":"\/Date(1456311600000+0100)\/","date_start":"\/Date(1456306200000+0100)\/","description":"20131 CLEFIN-FINANCE - Gatti S.-Della Ragione M.","id":8957,"supertitle":"Room N35","title":"Investment banking","type":1},{"date_end":"\/Date(1456318800000+0100)\/","date_start":"\/Date(1456313400000+0100)\/","description":"20192 CLEFIN-FINANCE - Guidolin M.-Favero C.","id":10360,"supertitle":"Room N35","title":"Financial econometrics and empirical finance - module 2","type":1},{"date_end":"\/Date(1456335900000+0100)\/","date_start":"\/Date(1456326900000+0100)\/","description":"20369 IM,EMIT,GIO,M,DES-ESS,MM,AFC,CLEFIN-FINANCE,ACME - Mattei M.","id":14394,"supertitle":"Room N37","title":"Italian language (lessons only)","type":1}]}]
```
#### Agenda for today
###### Request
```http
...
###### Request
```http
	GET /universityapp_prod/api/v6/students/257126/agenda?rl=en&start=20160131&end=20160206 HTTP/1.1
	auth_secret: b0cc0n1s3cr3t
	Authorization: BASIC [REDACTED]
	User-Agent: Dalvik/2.1.0 (Linux; U; Android 6.0; Custom Phone - 6.0.0 - API 23 - 768x1280 Build/MRA58K)
	Host: ks3-mobile.unibocconi.it
